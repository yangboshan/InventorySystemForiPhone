...
#import "ISDataSyncUnitFormatter.h"
#import "ISNetworkingSyncAPIHandler.h"
#import <GDataXML-HTML/GDataXMLNode.h>

@implementation ISDataSyncUnitFormatter
    ...
    if ([manager isKindOfClass:[ISNetworkingSyncAPIHandler class]]) {
        if ([data isKindOfClass:[NSData class]]) {
            ...
            for(GDataXMLElement * child in dataset.children){
                [retList addObject:[[ISDataBaseHelper sharedInstance] fetchModelFromXMLElement:child withEntity:@"ISUnitDataModel"]];
            }
