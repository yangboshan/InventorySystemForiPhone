...
- (UIButton*)titleView{
    if (!_titleView) {
        ...
        [_titleView setImage:[[UIImage imageNamed:@"photopicker_arrow_down"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate] forState:UIControlStateNormal];
        [_titleView setImage:[[UIImage imageNamed:@"photopicker_arrow_up"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate] forState:UIControlStateSelected];
